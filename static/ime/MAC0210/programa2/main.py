...
def case_6():
    ...
    shutil.copy("balotelli.png", os.path.join(case_6_dir, "balotelli.png"))
    compress(os.path.join(case_6_dir, "balotelli.png"), k=1)
    os.rename("compressed.png", os.path.join(case_6_dir, "compressed_k1.png"))

    compress(os.path.join(case_6_dir, "balotelli.png"), k=3)
    ...
    generate_error_graph(
        os.path.join(case_6_dir, "balotelli.png"), 
        [
